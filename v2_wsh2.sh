...
cd /etc/caddy/
rm -f Caddyfile
wget https://raw.githubusercontent.com/Lightmani/Docker_NetTools/master/config/Caddy2 -cO Caddyfile
...
rm config.json
*****************************************
wget https://raw.githubusercontent.com/Lightmani/Docker_NetTools/master/config/v3.config  -cO config.json
